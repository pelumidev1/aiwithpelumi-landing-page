...
* **Signup note (updated 2026-08-20):** under every one of the three forms — "The weekly email is free. The masterclass isn't. It's a separate class you pay for, and you'll see the details right after you sign up." Required, not decorative: a successful signup swaps the form for a link to the paid masterclass checkout (`MASTERCLASS_URL` in `script.js`, `https://selar.com/buidwithaimasterclass`), and nobody should meet a price they were not warned about. The masterclass was never a free add-on to the newsletter; the earlier WhatsApp-group wording is retired.
